...
export default function BudgetSelector({ options, name, register, required = false }: BudgetSelectorProps) {
      ...
      {options.map((option) => (
        ...
        >
          ...
          >
            ...
            `}
            >
              <DollarSign className={selectedValue === option.value ? "text-primary" : "text-foreground/60"} />
            </div>
            <span
              className={`
